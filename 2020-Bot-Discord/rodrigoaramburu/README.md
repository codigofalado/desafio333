...
O bot tem suas funcionalidades divididas em "subbots", ao ser adicionado a um servidor do Discord todas as funcionalidades estão por padrão desatividas e devem ser ativadas em cada canal desejado através de comandos de gerenciamento.
