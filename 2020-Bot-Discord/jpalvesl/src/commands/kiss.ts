...
const helpEmbed = new MessageEmbed()
  .setAuthor('Ajuda do comando kiss', 'https://cdn.pixabay.com/photo/2012/04/14/16/26/question-34499_960_720.png')
  .setThumbnail('https://cdn.discordapp.com/attachments/728421824521830452/730598731132436480/682055.png')
  .setDescription('Manda um beijinho para outro usuário.')
  .addFields([
    { name: 'Modo de usar', value: `\`${process.env.PREFIX}kiss <@user>\`` },
...
module.exports = { // como está utilizando require para importar os comandos vou usar o module.exports nessa parte
  ...
  guildOnly: false,
    ...
    const userMention = message.mentions.users.first()
		...
		message.channel.send(`${message.author.username}    :kissing_heart:    ${userMention?.username}`);
	},
};