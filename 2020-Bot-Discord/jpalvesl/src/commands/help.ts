...
const helpEmbed = new MessageEmbed()
  ...
  .addFields([
    { name: 'Modo de usar', value: `\`${process.env.PREFIX}help <comando>\`` },
...
module.exports = { // como está utilizando require para importar os comandos vou usar o module.exports nessa parte
  ...
  guildOnly: false,
    ...
    const helpEmbed = new MessageEmbed()
      ...
      .setFooter(`Para verificar a forma de usar o comando digite o comando ${process.env.PREFIX}help <comando>`, 'https://cdn.discordapp.com/avatars/724090193153622096/a02d4db5a8f5d962f2d0c1cb53bbbb1c.png')
