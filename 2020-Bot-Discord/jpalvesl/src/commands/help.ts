...
module.exports = { // como está utilizando require para importar os comandos vou usar o module.exports nessa parte
  ...
  guildOnly: false,
    ...
    const helpEmbed = new MessageEmbed()
      ...
      .addFields(
        // \`\`
        { name: 'Comandos de informações', value: `\`help\` \`avatar\` \`info\` \`invite\` \`roleinfo\` \`serverinfo\`` }, 
      ...
      .setTimestamp()
      .setFooter(`Para verificar a forma de usar o comando digite o comando ${prefix}help <comando>`)
